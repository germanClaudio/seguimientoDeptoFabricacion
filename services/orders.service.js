...
class OrdersService {
    ...
    // returns All items consumed by User/s between dates
    async getItemsConsumidosBySearchingUser(user) {
        return this.ordenes.getItemsConsumidosBySearchingUser(user)
    }
